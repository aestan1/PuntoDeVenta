...
namespace Proyecto.Formularios.Ventas
{
    public partial class frmListaVentas : Form
    {
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            DateTime dt1 = Convert.ToDateTime(txtfechainicio.Value.ToString("dd/MM/yyyy 00:00:00.000"));
            DateTime dt2 = Convert.ToDateTime(txtfechafin.Value.ToString("dd/MM/yyyy 23:59:59.999"));
            List<VistaVenta> lista = VentaLogica.Instancia.Resumen(dt1.ToString("yyyy-MM-dd 00:00:00.000", new CultureInfo("en-US")), dt2.ToString("yyyy-MM-dd 23:59:59.999", new CultureInfo("en-US")));
